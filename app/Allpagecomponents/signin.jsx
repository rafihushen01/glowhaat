...
const Signin = () => {
  ...
  return (
    <div
      className="min-h-screen bg-[radial-gradient(circle_at_14%_18%,#f6d8be_0%,#f7efe3_32%,#f6f4ee_62%,#edf6f1_100%)]"
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          >
            ...
            <form onSubmit={handleSignin} className="space-y-4">
              ...
              >
                {loading ? <Loader2 className="h-4 w-4 animate-spin" /> : t("title")}
              </motion.button>
              ...
              <p className="rounded-lg border border-[#dbe7e1] bg-[#f6faf8] px-3 py-2 text-xs text-[#4d6d60]">
                {t("googleSigninHint")}
              </p>
