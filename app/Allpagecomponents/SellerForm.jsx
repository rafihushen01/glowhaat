...
const inputClass = "mt-1 h-11 w-full rounded-xl border border-gray-200 px-3 text-sm bg-white outline-none focus:border-gray-500";
const textClass = "mt-1 min-h-[86px] w-full rounded-xl border bg-white border-gray-200 px-3 py-2 text-sm outline-none focus:border-gray-500";
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="w-full">
        <div className="border text-center border-gray-200 bg-emerald-50 p-6 md:p-8">
        ...
        {notice ? <div className="mt-4 rounded-xl border border-gray-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-800">{notice}</div> : null}

        {loadingStatus ? (
          <div className="mt-6 rounded-2xl border border-gray-200 bg-white p-6 text-sm text-emerald-800">Checking your seller status...</div>
        ) : status ? (
          <div className="mt-6 rounded-2xl border border-gray-200 bg-white p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <button
                ...
                className="rounded-full border border-gray-300 px-4 py-2 text-xs font-semibold uppercase tracking-[0.14em] text-emerald-800 disabled:cursor-not-allowed disabled:opacity-50"
              >
                Start New Request
              </button>
          ...
          <div className="grid xl:grid-cols-[1fr_1.8fr]">
            ...
            <div className="border border-gray-200 bg-white p-5">
              ...
              <div className="mt-4 rounded-xl border border-gray-200 bg-emerald-50 p-3">
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  {categories.map((cat) => {
                    ...
                    return (
                      <button key={cat} type="button" onClick={() => toggleCategory(cat)} className={`rounded-full border px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.12em] ${active ? "border-gray-700 bg-emerald-700 text-white" : "border-gray-300 bg-white text-emerald-800"}`}>
                        {cat}
                      </button>
                    );
                  })}
                  ...
                  {SOCIAL_CHANNELS.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        className={`rounded-full border px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.12em] ${active ? "border-gray-700 bg-emerald-700 text-white" : "border-gray-300 bg-white text-emerald-800"}`}
                      >
                        {item.label}
                      </button>
                    );
              ...
              <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-2">
                {IMAGE_FIELDS.map((field) => (
                  <label key={field.key} className="rounded-xl border border-gray-200 bg-emerald-50 p-3 text-sm">
